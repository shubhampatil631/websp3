...
const Create = () => {
  ...
  const handlesetSubmitedUsername = (e) => {
    setSubmitedUsername(e.target.value);
  };

  const handleSubmitedDepartment = (e) => {
    setSubmitedDepartment(e.target.value);
  };
  const Submitform = (e) => {
    e.preventDefault();
    console.log("Submitted username:", SubmitedUsername);
    console.log("Submitted department:", SubmitedDepartment);
    axios
        ...
        <form>
          <div className="flexinputn1">
            ...
            <input
              ...
              onChange={handlesetSubmitedUsername}
            />
            <label>
              <h4>Department</h4>
            </label>
            <input
              ...
              onChange={handleSubmitedDepartment}
            />
          </div>
          <div className="flexinputn1">
            <label>
          ...
          <div>
            ...
            <select value={Year} onChange={(e) => setLYear(e.target.value)}>
              <option>select</option>
              <option>प्रथम वर्ष</option>
              <option>द्वितीय</option>
            </select>{" "}
